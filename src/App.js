...
const initialCountriesSF2 = [
  { id: "bg", name: "Bulgaria", song: "DARA — Bangaranga", flag: "https://www.eurovision.com/static/images/flags/flag_bg.svg", image: "https://storage.googleapis.com/eurovision-com.appspot.com/renditions/public/cms/bulgariajpg/Bulgaria-fill_size%3D2560x1600-focal_point%3D1288x394-focal_size%3D225x240.jpg", score: 0, note: "" },
  { id: "az", name: "Azerbaijan", song: "Jiva — Just Go", flag: "https://www.eurovision.com/static/images/flags/flag_az.svg", image: "https://storage.googleapis.com/eurovision-com.appspot.com/renditions/public/cms/alif4156-1jpg/ALIF4156%20%281%29-fill_size%3D2560x1600-focal_point%3D1298x447-focal_size%3D224x279.jpg", score: 0, note: "" },
  { id: "ro", name: "Romania", song: "Alexandra Căpitănescu — Choke Me", flag: "https://www.eurovision.com/static/images/flags/flag_ro.svg", image: "https://storage.googleapis.com/eurovision-com.appspot.com/renditions/public/cms/romaniajpg/Romania-fill_size%3D2560x1600-focal_point%3D1659x838-focal_size%3D348x296.jpg", score: 0, note: "" },
  ...
  { id: "cz", name: "Czechia", song: "Daniel Žižka — Crossroads", flag: "https://www.eurovision.com/static/images/flags/flag_cz.svg", image: "https://storage.googleapis.com/eurovision-com.appspot.com/renditions/public/cms/daniel-zizka_finals__img7135_dcg99uzjpg/Daniel%20Zizka_finals__IMG7135_dcG99Uz-fill_size%3D2560x1600-focal_point%3D765x673-focal_size%3D418x375.jpg", score: 0, note: "" },
  { id: "am", name: "Armenia", song: "SIMÓN — Paloma Rumba", flag: "https://www.eurovision.com/static/images/flags/flag_am.svg", image: "https://storage.googleapis.com/eurovision-com.appspot.com/renditions/public/cms/armeniajpg/Armenia-fill_size%3D2560x1600-focal_point%3D1383x749-focal_size%3D427x405.jpg", score: 0, note: "" },
  { id: "ch", name: "Switzerland", song: "Veronica Fusaro — Alice", flag: "https://www.eurovision.com/static/images/flags/flag_ch.svg", image: "https://storage.googleapis.com/eurovision-com.appspot.com/renditions/public/cms/switzerland_edk0ddyjpg/Switzerland_eDk0DdY-fill_size%3D2560x1600-focal_point%3D1219x615-focal_size%3D436x403.jpg", score: 0, note: "" },
  { id: "cy", name: "Cyprus", song: "Antigoni — Jalla", flag: "https://www.eurovision.com/static/images/flags/flag_cy.svg", image: "https://storage.googleapis.com/eurovision-com.appspot.com/renditions/public/cms/cyprus_qo5gwlojpg/Cyprus_qO5gWlo-fill_size%3D2560x1600-focal_point%3D880x1054-focal_size%3D629x507.jpg", score: 0, note: "" },
  { id: "lv", name: "Latvia", song: "Atvara — Enā", flag: "https://www.eurovision.com/static/images/flags/flag_lv.svg", image: "https://storage.googleapis.com/eurovision-com.appspot.com/renditions/public/cms/latviajpeg/Latvia-fill_size%3D2560x1600-focal_point%3D1477x710-focal_size%3D392x459.jpeg", score: 0, note: "" },
  { id: "dk", name: "Denmark", song: "Søren Torpegaard Lund — Før vi går hjem", flag: "https://www.eurovision.com/static/images/flags/flag_dk.svg", image: "https://storage.googleapis.com/eurovision-com.appspot.com/renditions/public/cms/denmark_8rbh8gajpg/Denmark_8Rbh8gA-fill_size%3D2560x1600-focal_point%3D1283x368-focal_size%3D207x218.jpg", score: 0, note: "" },
  { id: "au", name: "Australia", song: "Delta Goodrem — Eclipse", flag: "https://www.eurovision.com/static/images/flags/flag_au.svg", image: "https://storage.googleapis.com/eurovision-com.appspot.com/renditions/public/cms/australiajpg/Australia-fill_size%3D2560x1600-focal_point%3D1268x831-focal_size%3D531x582.jpg", score: 0, note: "" },
  { id: "ua", name: "Ukraine", song: "Leléka — Ridnym", flag: "https://www.eurovision.com/static/images/flags/flag_ua.svg", image: "https://storage.googleapis.com/eurovision-com.appspot.com/renditions/public/cms/ukrainejpg/Ukraine-fill_size%3D2560x1600-focal_point%3D1138x849-focal_size%3D674x715.jpg", score: 0, note: "" },
  { id: "al", name: "Albania", song: "Alis — Nân", flag: "https://www.eurovision.com/static/images/flags/flag_al.svg", image: "https://storage.googleapis.com/eurovision-com.appspot.com/renditions/public/cms/img_6182jpeg/IMG_6182-fill_size%3D2560x1600-focal_point%3D917x593-focal_size%3D491x571.jpeg", score: 0, note: "" },
  { id: "mt", name: "Malta", song: "Aidan — Bella", flag: "https://www.eurovision.com/static/images/flags/flag_mt.svg", image: "https://storage.googleapis.com/eurovision-com.appspot.com/renditions/public/cms/maltajpg/Malta-fill_size%3D2560x1600-focal_point%3D1189x630-focal_size%3D317x302.jpg", score: 0, note: "" },
  { id: "no", name: "Norway", song: "Jonas Lovv — Ya ya ya", flag: "https://www.eurovision.com/static/images/flags/flag_no.svg", image: "https://storage.googleapis.com/eurovision-com.appspot.com/renditions/public/cms/norway_u2zlerkjpg/Norway_U2ZlERK-fill_size%3D2560x1600-focal_point%3D1090x1038-focal_size%3D739x691.jpg", score: 0, note: "" },
];
...
export default function EurovisionScoreboard() {
  ...
  const [countriesSF1, setCountriesSF1] = useState(() => {
    const saved = localStorage.getItem("esc-2026-sf1");
    return saved ? JSON.parse(saved) : initialCountriesSF1;
  });

  const [countriesSF2, setCountriesSF2] = useState(() => {
    const saved = localStorage.getItem("esc-2026-sf2");
    return saved ? JSON.parse(saved) : initialCountriesSF2;
  });

  const [isExporting, setIsExporting] = useState(false);

  useEffect(() => { localStorage.setItem("esc-2026-sf1", JSON.stringify(countriesSF1)); }, [countriesSF1]);
  useEffect(() => { localStorage.setItem("esc-2026-sf2", JSON.stringify(countriesSF2)); }, [countriesSF2]);
  ...
  const resetScores = () => {
    if (window.confirm(`Reset votes for ${semiTitle}?`)) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-gray-900 font-sans flex flex-col items-center">
      ...
      <div style={{ position: 'absolute', left: '-5000px', top: 0 }}>
        <div ref={exportRef} className="w-[1080px] h-[1920px] bg-[#f3f4f6] pt-[150px] pb-[100px] px-14 flex flex-col items-center justify-between">
          <header className="text-center flex flex-col items-center w-full mb-10">
            ...
            <h1 className="text-7xl font-black text-gray-900 mb-6 tracking-tighter italic uppercase">{semiTitle}</h1>
            <p className="text-gray-400 text-xl font-bold tracking-[0.4em] uppercase opacity-60 mb-10">{semiDate}</p>
            <div className="text-[#002FA7] text-7xl font-black uppercase italic">My Top 10</div>
          </header>
            ...
            {sorted.slice(0, 10).map((c, i) => (
              <div key={c.id} className="bg-white h-[105px] px-8 flex items-center justify-between rounded-[40px] border border-gray-200">
                <div className="flex items-center gap-8 h-full leading-none">
                  <span className="text-3xl font-black text-gray-200 italic w-10 text-center">{i + 1}</span>
                  ...
                  <div className="ml-1 text-left flex flex-col justify-center h-full">
                    <h2 className="text-[32px] font-black uppercase tracking-tighter leading-none mb-1 text-gray-900">{c.name}</h2>
                    <p className="text-gray-400 text-lg italic font-medium leading-none">{c.song}</p>
                  </div>
                </div>
                <div className="text-6xl font-black text-[#002FA7] tracking-tighter h-full flex items-center pb-5">{c.score}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* UI CONTROL BAR */}
      {!isExporting && (
        <div className="w-full bg-white/80 backdrop-blur-xl border-b border-gray-200 flex flex-col items-center sticky top-0 z-50 shadow-sm">
          <div className="flex justify-center gap-8 p-4 w-full">
            <button onClick={() => setActiveSemi("SF1")} className={`text-xs font-black uppercase tracking-widest pb-1 border-b-2 transition-all ${activeSemi === "SF1" ? "text-[#002FA7] border-[#002FA7]" : "text-gray-400 border-transparent"}`}>Semi-Final 1</button>
            <button onClick={() => setActiveSemi("SF2")} className={`text-xs font-black uppercase tracking-widest pb-1 border-b-2 transition-all ${activeSemi === "SF2" ? "text-[#002FA7] border-[#002FA7]" : "text-gray-400 border-transparent"}`}>Semi-Final 2</button>
          </div>
          <div className="pb-4 px-6 flex justify-center gap-3 w-full">
            {votingStarted ? (
              <>
                <button onClick={resetScores} className="px-4 py-2 bg-red-50 text-red-600 rounded-xl text-xs font-bold border border-red-100">Reset</button>
                <button onClick={downloadAsImage} disabled={votesCount !== 10} className={`px-4 py-2 rounded-xl text-xs font-bold transition-all ${votesCount === 10 ? "bg-[#002FA7] text-white shadow-lg" : "bg-gray-200 text-gray-400 cursor-not-allowed"}`}>Download Top 10</button>
              </>
            ) : ( <span className="text-gray-400 py-2 text-xs font-bold italic tracking-wide">Rank your Top 10 countries</span> )}
          </div>
        </div>
      )}

      {/* MAIN UI */}
      <div className="w-full max-w-4xl p-4 md:p-8 flex flex-col items-center">
        <header className="mb-12 text-center flex flex-col items-center">
          <img src={logoUrl} className="h-20 md:h-24 mb-4 object-contain" alt="Logo" />
          <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-2 italic uppercase tracking-tighter">{semiTitle}</h1>
          <p className="text-gray-400 text-[10px] font-bold tracking-[0.3em] uppercase">{semiDate}</p>
        </header>
        ...
        <div className="flex flex-col gap-4 w-full">
          {sorted.map((c, i) => (
            <React.Fragment key={c.id}>
              {votingStarted && i === 10 && (
                <div className="w-full py-8 flex items-center gap-6 px-4">
                  <div className="flex-1 h-px bg-gray-200"></div>
                  <span className="text-gray-300 text-[10px] font-black uppercase tracking-[0.4em]">Zero Points</span>
                  <div className="flex-1 h-px bg-gray-200"></div>
                </div>
              )}
              <motion.div layout className={`bg-white border p-4 md:p-5 flex flex-col md:flex-row items-center md:justify-between shadow-sm rounded-[30px] gap-4 ${c.score > 0 ? "border-[#002FA7]/20 ring-4 ring-[#002FA7]/5" : "border-gray-100"}`}>
                <div className="flex items-center gap-4 flex-1 w-full">
                  <span className="w-6 text-center text-sm font-bold text-gray-300 italic">{i + 1}</span>
                  <img src={c.flag} className="w-10 h-10 object-contain drop-shadow-sm rounded-full bg-slate-50 border border-white" alt="" />
                  <img src={c.image} alt="" className="w-24 md:w-28 h-14 md:h-16 rounded-xl object-cover bg-gray-100 shadow-sm border border-white/50" />
                  <div className="flex flex-col text-left flex-1 min-w-0">
                    <h2 className="text-lg md:text-xl font-black uppercase tracking-tighter leading-tight truncate">{c.name}</h2>
                    <p className="text-gray-500 text-xs md:text-sm italic font-medium truncate mb-2">{c.song}</p>
                    <input value={c.note || ""} onChange={(e) => updateNote(c.id, e.target.value)} placeholder="Add note..." className="w-full p-2 text-[10px] bg-slate-50 border border-gray-100 rounded-lg text-gray-600 outline-none focus:bg-white" />
                  </div>
                </div>
                <div className="flex items-center gap-4 shrink-0 w-full md:w-auto">
                  <div className="grid grid-cols-5 md:grid-cols-10 gap-1 flex-1">
                    {[1, 2, 3, 4, 5, 6, 7, 8, 10, 12].map((p) => {
                      const mine = c.score === p;
                      const taken = currentCountries.some((other) => other.id !== c.id && other.score === p);
                      return (
                        <button key={p} onClick={() => toggleScore(c.id, p)} className={`h-8 w-full md:w-8 flex items-center justify-center rounded-lg text-[10px] font-black transition-all border ${mine ? "bg-[#002FA7] text-white border-transparent scale-110 shadow-md" : taken ? "bg-gray-50 text-gray-200 border-gray-50 cursor-not-allowed" : "bg-white text-gray-700 border-gray-200 hover:border-[#002FA7]/30"}`}>{p}</button>
                      );
                    })}
                  </div>
                  <div className="w-10 text-center text-3xl font-black text-[#002FA7]">{c.score > 0 ? c.score : "-"}</div>
                </div>
              </motion.div>
            </React.Fragment>
          ))}
        ...
        <footer className="mt-20 mb-8 text-center text-gray-400 text-[10px] font-bold uppercase tracking-[0.3em] opacity-40">
          Created by <a href="https://www.instagram.com/artkuztom/" target="_blank" rel="noopener noreferrer" className="text-[#002FA7] hover:underline">Artyom Kuzmenko</a>
        </footer>
      </div>
      <Analytics />
    </div>
